...
enum OpCodes
{
    ...
    SMSG_CAST_FAILED                                = 0x130, // old SMSG_CAST_RESULT
    ...
    SMSG_ACCOUNT_DATA_TIMES                         = 0x209, // old SMSG_ACCOUNT_DATA_MD5
    ...
    SMSG_CLEAR_EXTRA_AURA_INFO                      = 0x3A6, // old SMSG_CAST_SUCCESS
