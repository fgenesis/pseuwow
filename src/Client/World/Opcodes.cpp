...
const char* worldOpcodeNames[] =
{
    ...
    "SMSG_INSTANCE_LOCK_QUERY", // 0x0147
    ...
    "SMSG_GAMEOBJECT_SPAWN_ANIM_OBSOLETE", // 0x0214
    ...
    "CMSG_LFG_SET_AUTOJOIN", // 0x035C
    "CMSG_LFG_CLEAR_AUTOJOIN", // 0x035D
    "CMSG_LFM_SET_AUTOFILL", // 0x035E
    "CMSG_LFM_CLEAR_AUTOFILL", // 0x035F
    "CMSG_ACCEPT_LFG_MATCH", // 0x0360
    "CMSG_DECLINE_LFG_MATCH", // 0x0361
    "CMSG_CANCEL_PENDING_LFG", // 0x0362
    "CMSG_CLEAR_LOOKING_FOR_GROUP", // 0x0363
    "CMSG_CLEAR_LOOKING_FOR_MORE", // 0x0364
    "CMSG_SET_LOOKING_FOR_MORE", // 0x0365
    "CMSG_SET_LFG_COMMENT", // 0x0366
    "SMSG_LFG_TIMEDOUT", // 0x0367
    "SMSG_LFG_OTHER_TIMEDOUT", // 0x0368
    "SMSG_LFG_AUTOJOIN_FAILED", // 0x0369
    "SMSG_LFG_AUTOJOIN_FAILED_NO_PLAYER", // 0x036A
    "SMSG_LFG_LEADER_IS_LFM", // 0x036B
    "SMSG_LFG_UPDATE", // 0x036C
    "SMSG_LFG_UPDATE_LFM", // 0x036D
    "SMSG_LFG_UPDATE_LFG", // 0x036E
    "SMSG_LFG_UPDATE_QUEUED", // 0x036F
    "SMSG_LFG_PENDING_INVITE", // 0x0370
    "SMSG_LFG_PENDING_MATCH", // 0x0371
    "SMSG_LFG_PENDING_MATCH_DONE", // 0x0372
    ...
    "CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY", // 0x0417
    ...
    "CMSG_QUERY_VEHICLE_STATUS", // 0x04A4
    "UMSG_UNKNOWN_1189", // 0x04A5
    "SMSG_UNKNOWN_1190", // 0x04A6
    "SMSG_UNKNOWN_1191", // 0x04A7
    "CMSG_UNKNOWN_1192", // 0x04A8
    "CMSG_EJECT_PASSENGER", // 0x04A9
    "SMSG_PET_GUIDS", // 0x04AA
    "SMSG_CLIENTCACHE_VERSION", // 0x04AB
    "UMSG_UNKNOWN_1196", // 0x04AC
    "UMSG_UNKNOWN_1197", // 0x04AD
    "UMSG_UNKNOWN_1198", // 0x04AE
    "UMSG_UNKNOWN_1199", // 0x04AF
    "UMSG_UNKNOWN_1200", // 0x04B0
    "UMSG_UNKNOWN_1201", // 0x04B1
    "SMSG_UNKNOWN_1202", // 0x04B2
    "CMSG_UNKNOWN_1203", // 0x04B3
    "CMSG_UNKNOWN_1204", // 0x04B4
    "SMSG_UNKNOWN_1205", // 0x04B5
    "CMSG_UNKNOWN_1206", // 0x04B6
    "SMSG_UNKNOWN_1207", // 0x04B7
    "CMSG_LFG_SET_ROLES", // 0x04B8
    "UMSG_UNKNOWN_1209", // 0x04B9
    "CMSG_UNKNOWN_1210", // 0x04BA
    "SMSG_UNKNOWN_1211", // 0x04BB
    "SMSG_EQUIPMENT_SET_LIST", // 0x04BC
    "CMSG_EQUIPMENT_SET_SAVE", // 0x04BD
    "CMSG_UNKNOWN_1214", // 0x04BE
    "SMSG_UNKNOWN_1215", // 0x04BF
    "SMSG_TALENTS_INFO", // 0x04C0
    "CMSG_LEARN_PREVIEW_TALENTS", // 0x04C1
    "CMSG_LEARN_PREVIEW_TALENTS_PET", // 0x04C2
    "UMSG_UNKNOWN_1219", // 0x04C3
    "UMSG_UNKNOWN_1220", // 0x04C4
    "UMSG_UNKNOWN_1221", // 0x04C5
    "UMSG_UNKNOWN_1222", // 0x04C6
    "SMSG_UNKNOWN_1223", // 0x04C7
    "SMSG_UNKNOWN_1224", // 0x04C8
    "UMSG_UNKNOWN_1225", // 0x04C9
    "UMSG_UNKNOWN_1226", // 0x04CA
    "CMSG_EQUIPMENT_SET_USE", // 0x04CB
    "SMSG_EQUIPMENT_SET_USE_RESULT", // 0x04CC
    ""
};

const char *GetOpcodeName(unsigned int id)
{
    uint32 t = sizeof(worldOpcodeNames);
    if(id > MAX_OPCODE_ID)
        return "OPCODE_INVALID";
    if(id >= sizeof(worldOpcodeNames) / sizeof(char*))
        return "OPCODE_NAME_UNKNOWN";
